var debounceRender = function (instance) {
  console.log('entering debounceRender', instance.debounce);
	// If there's a pending render, cancel it
	if (instance.debounce) {
    console.log('cancel', instance.debounce);
		window.cancelAnimationFrame(instance.debounce);
	}
	// Setup the new render to run at the next animation frame
	instance.debounce = window.requestAnimationFrame(function () {
    instance.debounce = null;
    console.log('render', instance.debounce);
		instance.render();
	});
  console.log('raf', instance.debounce);
};
